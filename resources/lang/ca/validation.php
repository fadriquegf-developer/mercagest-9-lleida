...
return [
    ...
    'iban' => 'No és un IBAN vàlid.',
    'custom'               => [
        'email'    => [
            'unique' => 'El correu electrònic indicat ja s\'està utilitzant',
        ],
        'dni'    => [
            'unique' => 'El DNI indicat ja s\'està utilitzant',
        ],
        'password' => [
    ...
    'values' => [
        'act' => [
            'myself' => 'Persona interessada',
            'other' => 'persona representant',
        ],
    ],
];

                                    ...
                                    <tr>
                                        <td>
                                            <div class="form-check">
                                                <input
                                                    class="form-check-input @error('national_insurance') is-invalid @enderror"
                                                    type="checkbox" value="national_insurance" id="national_insurance"
                                                    name="national_insurance" @checked(old('national_insurance') == 'national_insurance')>

...
@section('content')
    ...
    <div class="row mt-5" id="container_calendar">
        <div class="col-sm-8 m-auto" id="calendar">
        </div>
    </div>
@endsection
...
@section('after_styles')
    ...
    <link rel="stylesheet" type="text/css"
          href="{{ asset('packages/fullcalendar-5.11.0/lib/main.min.css') }}">
...
@section('after_scripts')
    ...
    @include('admin.calendar.list_script')
    <script type="text/javascript" src="{{ asset('packages/fullcalendar-5.11.0/lib/main.min.js') }}"></script>
    <script type="text/javascript" src="{{ asset('packages/fullcalendar-5.11.0/lib/locales/ca.js') }}"></script>
    <script>
        $( document ).ready(function() {
            $('#calendar').hide();
            $("#calendar_view").on('click', function(){
                $('#crudTable').hide();
                $('#crudTable_wrapper').hide();
                $('.navbar-filters').hide();
                $('#calendar').show();
            });

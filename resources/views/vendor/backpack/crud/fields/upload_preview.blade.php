...
@if (!empty($field['value']))
    <div class="existing-file">
        ...
        <a href="#" class="file_clear_button btn btn-light btn-sm float-right" title="Clear file"><i
                class="la la-remove"></i></a>
        <div class="clearfix"></div>
        <img class="img-fluid col-sm-6 pb-2" src="{{ asset(Arr::get($field, 'prefix', '') . $field['value']) }}" height="250">
    </div>
@endif

{{-- Show the file picker on CREATE form. --}}
<div class="backstrap-file {{ isset($field['value']) && $field['value'] != null ? 'd-none' : '' }}">
    <input type="file" name="{{ $field['name'] }}" @include('crud::fields.inc.attributes', [
        'default_class' =>

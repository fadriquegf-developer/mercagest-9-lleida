...
class ReasonCrudController extends CrudController
{
    ...
    public function setup()
    {
        ...
        CRUD::setEntityNameStrings(trans('backpack.reasons.single'), trans('backpack.reasons.plural'));
    }
    ...
    protected function setupListOperation()
    {
        ...
        $this->crud->addColumn([
            'label' => trans('backpack.reasons.title'),
            'name' => 'title'
        ]);

        $this->crud->addColumn([
            'label' => trans('backpack.reasons.slug'),
            'name' => 'slug'
        ]);
